...
CITY_CHOICES = [
    ...
    ('Bikaner', 'Bikaner'), ('Bilaspur', 'Bilaspur'), ('Bokaro', 'Bokaro'),
    ('Chandigarh', 'Chandigarh'), ('Chennai', 'Chennai'), ('Coimbatore', 'Coimbatore'), ('Cuttack', 'Cuttack'),
    ...
    ('Haldwani', 'Haldwani'), ('Haridwar', 'Haridwar'), ('Hazaribagh', 'Hazaribagh'), ('Hisar', 'Hisar'),
    ...
    ('Kanpur', 'Kanpur'), ('Karimnagar', 'Karimnagar'), ('Karnal', 'Karnal'), ('Kavaratti', 'Kavaratti'),
    ('Kharagpur', 'Kharagpur'), ('Kochi', 'Kochi'), ('Kohima', 'Kohima'), ('Kolhapur', 'Kolhapur'),
    ('Kolkata', 'Kolkata'), ('Kollam', 'Kollam'), ('Korba', 'Korba'), ('Kota', 'Kota'),
    ('Kottayam', 'Kottayam'), ('Kozhikode', 'Kozhikode (Calicut)'), ('Kullu', 'Kullu'), ('Kurnool', 'Kurnool'),
    ('Leh', 'Leh'), ('Lucknow', 'Lucknow'), ('Ludhiana', 'Ludhiana'),
    ('Madurai', 'Madurai'), ('Mandi', 'Mandi'), ('Mangaluru', 'Mangaluru (Mangalore)'), ('Margao', 'Margao'),
    ...
    ('Raipur', 'Raipur'), ('Rajahmundry', 'Rajahmundry'), ('Rajkot', 'Rajkot'), ('Ranchi', 'Ranchi'),
    ...
    ('Shillong', 'Shillong'), ('Shimla', 'Shimla'), ('Silchar', 'Silchar'), ('Siliguri', 'Siliguri'),
    ...
    ('Tiruppur', 'Tiruppur'),
    ('Udaipur', 'Udaipur'), ('Ujjain', 'Ujjain'),
    ('Vadodara', 'Vadodara'), ('Varanasi', 'Varanasi'), ('Vasai-Virar', 'Vasai-Virar'),
    ('Vasco da Gama', 'Vasco da Gama'), ('Vellore', 'Vellore'), ('Vijayawada', 'Vijayawada'),
