...
CITY_CHOICES = [
    ('', 'Select city'),
    ('Agartala', 'Agartala'), ('Agra', 'Agra'), ('Ahmedabad', 'Ahmedabad'), ('Aizawl', 'Aizawl'),
    ('Ajmer', 'Ajmer'), ('Aligarh', 'Aligarh'), ('Ambala', 'Ambala'), ('Amravati', 'Amravati'),
    ('Amritsar', 'Amritsar'), ('Asansol', 'Asansol'), ('Aurangabad', 'Aurangabad'),
    ('Bagalkot', 'Bagalkot'), ('Ballari', 'Ballari (Bellary)'),
    ('Bareilly', 'Bareilly'), ('Belagavi', 'Belagavi'), ('Bengaluru', 'Bengaluru (Bangalore)'),
    ('Berhampur', 'Berhampur'), ('Bhagalpur', 'Bhagalpur'), ('Bharatpur', 'Bharatpur'),
    ('Bhavnagar', 'Bhavnagar'), ('Bhilai', 'Bhilai'), ('Bhopal', 'Bhopal'), ('Bhubaneswar', 'Bhubaneswar'),
    ('Bidar', 'Bidar'), ('Bikaner', 'Bikaner'), ('Bilaspur', 'Bilaspur'), ('Bokaro', 'Bokaro'),
    ('Chamarajanagar', 'Chamarajanagar'), ('Chandigarh', 'Chandigarh'), ('Chennai', 'Chennai'),
    ('Chikkaballapur', 'Chikkaballapur'), ('Chikkamagaluru', 'Chikkamagaluru'), ('Chitradurga', 'Chitradurga'),
    ('Coimbatore', 'Coimbatore'), ('Cuttack', 'Cuttack'),
    ('Daman', 'Daman'), ('Darbhanga', 'Darbhanga'), ('Davanagere', 'Davanagere'), ('Dehradun', 'Dehradun'),
    ('Delhi', 'Delhi / New Delhi'), ('Dhanbad', 'Dhanbad'), ('Dharamshala', 'Dharamshala'),
    ('Dibrugarh', 'Dibrugarh'), ('Dimapur', 'Dimapur'), ('Durg', 'Durg'), ('Durgapur', 'Durgapur'),
    ('Erode', 'Erode'),
    ('Faridabad', 'Faridabad'), ('Firozabad', 'Firozabad'),
    ('Gadag', 'Gadag'),
    ('Gandhinagar', 'Gandhinagar'), ('Gangtok', 'Gangtok'), ('Gaya', 'Gaya'), ('Ghaziabad', 'Ghaziabad'),
    ('Gorakhpur', 'Gorakhpur'), ('Greater Noida', 'Greater Noida'), ('Gurugram', 'Gurugram (Gurgaon)'),
    ('Guwahati', 'Guwahati'), ('Gwalior', 'Gwalior'),
    ('Haldwani', 'Haldwani'), ('Haridwar', 'Haridwar'), ('Hassan', 'Hassan'), ('Haveri', 'Haveri'),
    ('Hazaribagh', 'Hazaribagh'), ('Hisar', 'Hisar'), ('Hosapete', 'Hosapete (Hospet)'),
    ('Howrah', 'Howrah'), ('Hubballi-Dharwad', 'Hubballi-Dharwad'), ('Hyderabad', 'Hyderabad'),
    ('Imphal', 'Imphal'), ('Indore', 'Indore'), ('Itanagar', 'Itanagar'),
    ('Jabalpur', 'Jabalpur'), ('Jaipur', 'Jaipur'), ('Jalandhar', 'Jalandhar'), ('Jammu', 'Jammu'),
    ('Jamnagar', 'Jamnagar'), ('Jamshedpur', 'Jamshedpur'), ('Jhansi', 'Jhansi'), ('Jodhpur', 'Jodhpur'),
    ('Jorhat', 'Jorhat'), ('Junagadh', 'Junagadh'),
    ('Kakinada', 'Kakinada'), ('Kalaburagi', 'Kalaburagi (Gulbarga)'), ('Kannur', 'Kannur'),
    ('Kanpur', 'Kanpur'), ('Karimnagar', 'Karimnagar'), ('Karnal', 'Karnal'), ('Karwar', 'Karwar'),
    ('Kavaratti', 'Kavaratti'),
    ('Kharagpur', 'Kharagpur'), ('Kochi', 'Kochi'), ('Kohima', 'Kohima'), ('Kolar', 'Kolar'),
    ('Kolhapur', 'Kolhapur'),
    ('Kolkata', 'Kolkata'), ('Kollam', 'Kollam'), ('Koppal', 'Koppal'), ('Korba', 'Korba'), ('Kota', 'Kota'),
    ('Kottayam', 'Kottayam'), ('Kozhikode', 'Kozhikode (Calicut)'), ('Kullu', 'Kullu'), ('Kurnool', 'Kurnool'),
    ('Leh', 'Leh'), ('Lucknow', 'Lucknow'), ('Ludhiana', 'Ludhiana'),
    ('Madikeri', 'Madikeri'), ('Madurai', 'Madurai'), ('Mandi', 'Mandi'), ('Mandya', 'Mandya'),
    ('Mangaluru', 'Mangaluru (Mangalore)'), ('Margao', 'Margao'),
    ('Meerut', 'Meerut'), ('Mohali', 'Mohali'), ('Moradabad', 'Moradabad'), ('Mumbai', 'Mumbai'),
    ('Muzaffarnagar', 'Muzaffarnagar'), ('Muzaffarpur', 'Muzaffarpur'), ('Mysuru', 'Mysuru (Mysore)'),
    ('Nagpur', 'Nagpur'), ('Naharlagun', 'Naharlagun'), ('Nainital', 'Nainital'), ('Nashik', 'Nashik'),
    ('Navi Mumbai', 'Navi Mumbai'), ('Nellore', 'Nellore'), ('Nizamabad', 'Nizamabad'), ('Noida', 'Noida'),
    ('Panaji', 'Panaji'), ('Panipat', 'Panipat'), ('Patiala', 'Patiala'), ('Patna', 'Patna'),
    ('Port Blair', 'Port Blair'), ('Prayagraj', 'Prayagraj (Allahabad)'), ('Puducherry', 'Puducherry'),
    ('Pune', 'Pune'), ('Purnia', 'Purnia'),
    ('Raichur', 'Raichur'), ('Raipur', 'Raipur'), ('Rajahmundry', 'Rajahmundry'), ('Rajkot', 'Rajkot'),
    ('Ramanagara', 'Ramanagara'), ('Ranchi', 'Ranchi'),
    ('Ratlam', 'Ratlam'), ('Rewa', 'Rewa'), ('Rishikesh', 'Rishikesh'), ('Rohtak', 'Rohtak'),
    ('Rourkela', 'Rourkela'),
    ('Sagar', 'Sagar'), ('Saharanpur', 'Saharanpur'), ('Salem', 'Salem'), ('Sambalpur', 'Sambalpur'),
    ('Shillong', 'Shillong'), ('Shimla', 'Shimla'), ('Shivamogga', 'Shivamogga (Shimoga)'),
    ('Silchar', 'Silchar'), ('Siliguri', 'Siliguri'),
    ('Silvassa', 'Silvassa'), ('Solan', 'Solan'), ('Solapur', 'Solapur'), ('Srinagar', 'Srinagar'),
    ('Surat', 'Surat'),
    ('Thane', 'Thane'), ('Thiruvananthapuram', 'Thiruvananthapuram (Trivandrum)'), ('Thrissur', 'Thrissur'),
    ('Tiruchirappalli', 'Tiruchirappalli (Trichy)'), ('Tirunelveli', 'Tirunelveli'), ('Tirupati', 'Tirupati'),
    ('Tiruppur', 'Tiruppur'), ('Tumakuru', 'Tumakuru (Tumkur)'),
    ('Udaipur', 'Udaipur'), ('Udupi', 'Udupi'), ('Ujjain', 'Ujjain'),
    ('Vadodara', 'Vadodara'), ('Varanasi', 'Varanasi'), ('Vasai-Virar', 'Vasai-Virar'),
    ('Vasco da Gama', 'Vasco da Gama'), ('Vellore', 'Vellore'), ('Vijayapura', 'Vijayapura (Bijapur)'),
    ('Vijayawada', 'Vijayawada'),
    ('Visakhapatnam', 'Visakhapatnam (Vizag)'),
    ('Warangal', 'Warangal'),
    ('Yadgir', 'Yadgir'), ('Yamunanagar', 'Yamunanagar'),
    ('Other', 'Other'),
]
...
class NavbarCustomizationForm(forms.ModelForm):
    class Meta:
        model = SiteSettings
        fields = ('logo_type', 'logo_image', 'loader_logo_image', 'admin_logo_image', 'favicon', 'facebook_url', 'instagram_url', 'youtube_url', 'whatsapp_number')
        widgets = {
            ...
            'loader_logo_image': forms.FileInput(),
